 ...
 * @author rachmad
 */
public class InsertUpdateUtility extends javax.swing.JFrame {
    TestConnection tc;
    LoadTable tb;
    int status;
    /**
     ...
     */
    JTable jTable1;
    public InsertUpdateUtility(JTable jTable1, int status) {
        tc = new TestConnection();
        tb = new LoadTable(tc.getConnection(), "select * from utility");
        this.jTable1 = jTable1;
        this.status = status;
        initComponents();
    }
    
    public InsertUpdateUtility(JTable jTable1, int status, Object[] data){
        tc = new TestConnection();
        tb = new LoadTable(tc.getConnection(), "select * from utility");
        this.jTable1 = jTable1;
        this.status = status;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InsertUpdateUtility.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InsertUpdateUtility(null,0).setVisible(true);
            }
        });
    }
